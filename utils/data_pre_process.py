...
def train_helpdesk(file, time_unit):
    ...
    del csv_data['CompleteTimestamp']
    csv_data.to_csv('./vecData/helpdesk.csv', index=False)
    print(data_list)
...
if __name__ == '__main__':
    path = "./fillnaData/"
    # fileList = ['helpdesk.csv','BPI_Challenge_2012.csv','BPI_Challenge_2017.csv','HospitalBilling.csv','SepsisCases.csv','traffic_fines.csv']
